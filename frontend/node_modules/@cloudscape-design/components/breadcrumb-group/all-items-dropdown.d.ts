...
export declare const AllItemsDropdown: ({ items, onItemClick, onItemFollow }: FullCollapsedDropdownProps) => JSX.Element;
export {};
//# sourceMappingURL=all-items-dropdown.d.ts.map