...
.awsui_tabs-header_14rmt_7y4gf_154:not(#\9) {
  margin-block: 0;
  margin-inline: 0;
  padding-block: 0;
  padding-inline: 0;
...
.awsui_tab-header-scroll-container_14rmt_7y4gf_163:not(#\9) {
  display: flex;
  flex-grow: 1;
  max-inline-size: 100%;
}

.awsui_tabs-header-list_14rmt_7y4gf_169:not(#\9) {
  margin-block: 0;
  margin-inline: 0;
  padding-block: 0;
  padding-inline: 0;
...
.awsui_tabs-header-list_14rmt_7y4gf_169:not(#\9)::-webkit-scrollbar {
  display: none; /* Safari and Chrome */
}

.awsui_pagination-button_14rmt_7y4gf_187:not(#\9) {
...
.awsui_actions-container_14rmt_7y4gf_209:not(#\9) {
  flex-shrink: 0;
  align-self: center;
...
.awsui_tabs-tab_14rmt_7y4gf_217:not(#\9) {
  list-style: none;
  padding-block: 0;
  padding-inline: 0;
  flex-shrink: 0;
...
.awsui_tabs-tab-label_14rmt_7y4gf_227:not(#\9) {
  display: flex;
  align-items: center;
  padding-inline: var(--space-xs-ymlm0b, 8px);
...
.awsui_tabs-tab-header-container_14rmt_7y4gf_238:not(#\9) {
  position: relative;
...
.awsui_tabs-tab-header-container_14rmt_7y4gf_238:not(#\9), .awsui_tabs-tab-header-container_14rmt_7y4gf_238 > button:not(#\9) {
  background-color: transparent;
}
.awsui_tabs-tab-header-container_14rmt_7y4gf_238 > .awsui_tabs-tab-dismiss_14rmt_7y4gf_249:not(#\9), .awsui_tabs-tab-header-container_14rmt_7y4gf_238 > .awsui_tabs-tab-action_14rmt_7y4gf_249:not(#\9) {
  position: relative;
  display: flex;
  align-items: center;
}
.awsui_tabs-tab-header-container_14rmt_7y4gf_238.awsui_refresh_14rmt_7y4gf_254 > span:not(#\9):first-of-type {
  margin-inline-start: calc(-1 * var(--space-scaled-xs-xwoogq, 8px));
}

.awsui_tabs-tab-header-container_14rmt_7y4gf_238:not(#\9):not(.awsui_tabs-tab-disabled_14rmt_7y4gf_258):after {
  content: "";
  position: absolute;
...
.awsui_tabs-tab-header-container_14rmt_7y4gf_238:not(#\9):not(.awsui_tabs-tab-disabled_14rmt_7y4gf_258).awsui_refresh_14rmt_7y4gf_254:after {
...
.awsui-motion-disabled .awsui_tabs-tab-header-container_14rmt_7y4gf_238:not(#\9):not(.awsui_tabs-tab-disabled_14rmt_7y4gf_258).awsui_refresh_14rmt_7y4gf_254:after, .awsui-mode-entering .awsui_tabs-tab-header-container_14rmt_7y4gf_238:not(#\9):not(.awsui_tabs-tab-disabled_14rmt_7y4gf_258).awsui_refresh_14rmt_7y4gf_254:after {
  animation: none;
  transition: none;
}

.awsui_tabs-tab_14rmt_7y4gf_217:not(#\9):not(:last-child) > .awsui_tabs-tab-header-container_14rmt_7y4gf_238 {
  margin-inline-end: calc(-1 * var(--border-divider-section-width-uwo8my, 1px));
}
.awsui_tabs-tab_14rmt_7y4gf_217:not(#\9):not(:last-child) > .awsui_tabs-tab-header-container_14rmt_7y4gf_238:before {
  content: "";
  position: absolute;
...
.awsui_tabs-tab_14rmt_7y4gf_217:not(#\9):not(:last-child) > .awsui_tabs-tab-header-container_14rmt_7y4gf_238.awsui_refresh_14rmt_7y4gf_254:before {
  inset: calc(var(--space-static-s-t763lu, 12px) - var(--border-active-width-axzm24, 4px)) 0;
}

.awsui_tabs-tab-link_14rmt_7y4gf_300:not(#\9) {
  position: relative;
  display: flex;
  align-items: stretch;
...
.awsui_tabs-tab-link_14rmt_7y4gf_300.awsui_refresh_14rmt_7y4gf_254:not(#\9) {
  padding-block-start: calc(var(--space-static-xs-gnm0mz, 8px) - 1px);
  padding-block-end: calc(var(--space-static-xs-gnm0mz, 8px) - 1px);
  margin-block-start: 0;
}
.awsui_tabs-tab-link_14rmt_7y4gf_300:not(#\9):hover {
  color: var(--color-text-accent-n1kmht, #006ce0);
}
.awsui_tabs-tab-link_14rmt_7y4gf_300:not(#\9):focus {
  outline: none;
}
body[data-awsui-focus-visible=true] .awsui_tabs-tab-link_14rmt_7y4gf_300:not(#\9):focus {
  z-index: 1;
...
body[data-awsui-focus-visible=true] .awsui_tabs-tab-link_14rmt_7y4gf_300:not(#\9):focus::before {
  content: " ";
  display: block;
  position: absolute;
...
.awsui_tabs-tab_14rmt_7y4gf_217:not(#\9):first-child {
  margin-inline-start: 1px;
  scroll-margin-inline-start: 1px;
}
.awsui_tabs-tab_14rmt_7y4gf_217:not(#\9):first-child > .awsui_tabs-tab-header-container_14rmt_7y4gf_238 {
  padding-inline-start: calc(var(--space-xs-ymlm0b, 8px) - 1px);
}

.awsui_tabs-tab_14rmt_7y4gf_217:not(#\9):last-child {
  margin-inline-end: 1px;
  scroll-margin-inline-end: 1px;
}
.awsui_tabs-tab_14rmt_7y4gf_217:not(#\9):last-child > .awsui_tabs-tab-header-container_14rmt_7y4gf_238 {
  padding-inline-end: calc(var(--space-xs-ymlm0b, 8px) - 1px);
}

.awsui_tabs-tab-disabled_14rmt_7y4gf_258:not(#\9), .awsui_tabs-tab-disabled_14rmt_7y4gf_258:not(#\9):hover {
  cursor: default;
  color: var(--color-text-interactive-disabled-1bqmrl, #b4b4bb);
  font-weight: var(--font-tabs-disabled-weight-e3lt4d, 700);
}

.awsui_tabs-tab-active_14rmt_7y4gf_378:not(#\9):not(.awsui_tabs-tab-disabled_14rmt_7y4gf_258) {
  color: var(--color-text-accent-n1kmht, #006ce0);
}
.awsui_tabs-tab-active_14rmt_7y4gf_378:not(#\9):not(.awsui_tabs-tab-disabled_14rmt_7y4gf_258):after {
  opacity: 1;
}

.awsui_tabs-header-with-divider_14rmt_7y4gf_385:not(#\9) {
  border-block-end: var(--border-divider-section-width-uwo8my, 1px) solid var(--color-border-tabs-divider-f5t9va, #c6c6cd);
}

.awsui_tabs-tab-focusable_14rmt_7y4gf_389:not(#\9) {
  /* used to manage focusable logic */
}

.awsui_root_14rmt_7y4gf_393:not(#\9) {
  /* used in test-utils or tests */
}

.awsui_tabs_14rmt_7y4gf_154:not(#\9) {
...
.awsui_tabs-content_14rmt_7y4gf_431:not(#\9) {
  display: none;
}

.awsui_fit-height_14rmt_7y4gf_435:not(#\9) {
  display: flex;
  flex-direction: column;
  block-size: 100%;
}

.awsui_tabs-content-active_14rmt_7y4gf_441:not(#\9) {
  display: block;
  flex: 1;
}
body[data-awsui-focus-visible=true] .awsui_tabs-content-active_14rmt_7y4gf_441:not(#\9):focus {
  outline: 2px dotted transparent;
  outline-offset: 2px;
...
.awsui_tabs-content-wrapper_14rmt_7y4gf_455.awsui_with-paddings_14rmt_7y4gf_455 > .awsui_tabs-content_14rmt_7y4gf_431:not(#\9) {
  padding-block: var(--space-scaled-m-m892r9, 16px);
  padding-inline: 0;
}
.awsui_fit-height_14rmt_7y4gf_435 > .awsui_tabs-content-wrapper_14rmt_7y4gf_455:not(#\9) {
  flex: 1;
  display: flex;
  flex-direction: column;
  overflow: auto;
...
.awsui_fit-height_14rmt_7y4gf_435 > .awsui_tabs-content-wrapper_14rmt_7y4gf_455 > .awsui_tabs-container-content-wrapper_14rmt_7y4gf_466:not(#\9) {
  block-size: 100%;
  display: flex;
  flex-direction: column;
}
.awsui_tabs-container-content-wrapper_14rmt_7y4gf_466.awsui_with-paddings_14rmt_7y4gf_455 > .awsui_tabs-content_14rmt_7y4gf_431:not(#\9) {
...
.awsui_disabled-reason-tooltip_14rmt_7y4gf_477:not(#\9) {
  /* used in test-utils or tests */
}

.awsui_tabs-tab-focused_14rmt_7y4gf_481:not(#\9) {
