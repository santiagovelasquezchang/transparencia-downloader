...
.awsui_selectable-item_15o6u_lx7py_145:not(#\9) {
  ...
  border-block-start-color: var(--color-border-dropdown-item-default-kape37, #c6c6cd);
  border-block-end-color: var(--color-border-dropdown-item-default-kape37, #c6c6cd);
